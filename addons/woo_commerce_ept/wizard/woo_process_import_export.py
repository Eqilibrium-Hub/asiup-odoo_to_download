...
class WooProcessImportExport(models.TransientModel):
    ...
    def execute(self):
        ...
        if self.woo_operation == "import_customer":
            queues = self.with_delay(description='Create sync customer process').woo_import_customers()
            ...
            queues = self.with_delay(description='Create sync product process').get_products_from_woo()
            ...
            self.with_delay(description='Create sync product tags process').sync_product_tags()
        elif self.woo_operation == "import_attribute":
            self.with_delay(description='Create sync attribute process').sync_woo_attributes()
        elif self.woo_operation == "import_category":
            self.with_delay(description='Create sync category process').sync_woo_product_category()
        elif self.woo_operation == "import_unshipped_orders":
            self.with_delay(description='Create sync unshipped order process').import_sale_orders()
        elif self.woo_operation == "import_completed_orders":
            queues = self.with_delay(description='Create sync completed order process').import_sale_orders(order_type='completed')
            ...
            self.with_delay(description='Create sync update order status process').update_order_status()
        elif self.woo_operation == 'import_stock':
            self.with_delay(description='Create import stock process').import_stock()
        elif self.woo_operation == "export_stock":
            self.with_delay(description='Create export stock process').update_stock_in_woo()
        elif self.woo_operation == "update_tags":
            self.with_delay(description='Create update tags process').update_tags_in_woo()
        elif self.woo_operation == "export_tags":
            self.with_delay(description='Create export tags process').export_tags_in_woo()
        elif self.woo_operation == "update_category":
            self.with_delay(description='Create update category process').update_product_categ()
        elif self.woo_operation == "export_category":
            self.with_delay(description='Create export category process').export_product_categ()
        elif self.woo_operation == "import_coupon":
            queues = self.with_delay(description='Create sync coupon process').import_woo_coupon()
            ...
            self.with_delay(description='Create export coupon process').export_woo_coupons()
        elif self.woo_operation == "update_coupon":
            self.with_delay(description='Create update coupon process').update_woo_coupons()
        elif self.woo_operation == "import_product_from_csv":
            self.with_delay(description='Create import product from csv process').import_products_from_csv()
    ...
    def get_products_from_woo(self):
        ...
        # self.env['woo.product.data.queue.line.ept'].woo_image_import()
    ...
    def woo_export_products(self):
        ...
        self.with_delay(description='Sync new product to Woo').process_woo_export_products(woo_template_ids)

    def process_woo_export_products(self, woo_template_ids):
        ...
        woo_template_ids = woo_template_ids
    ...
    def update_products(self):
        ...
        self.with_delay(description='Update product on Woo').process_update_products(woo_tmpl_ids)

    def process_update_products(self, woo_tmpl_ids):
        """
    ...
    def preapre_template_vals_from_csv_data(self, record, instance_id, product_type):
        ...
        if self.env["ir.config_parameter"].sudo().get_param("woo_commerce_ept.set_sales_description"):
            woo_template_vals.update({'woo_description': record.get('description_sale'),
