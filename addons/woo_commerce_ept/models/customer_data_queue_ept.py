...
class WooCustomerDataQueueEpt(models.Model):
    ...
    def import_customer_queue(self):
        self.env['woo.manual.queue.process.ept'].with_context(queue_type='customer', active_ids=[self.id]).process_queue_manually()
    ...
    def create(self, vals):
        ...
        res = super(WooCustomerDataQueueEpt, self).create(vals)
        res.with_delay(description='Sync customer from Woo').import_customer_queue()
        return res
