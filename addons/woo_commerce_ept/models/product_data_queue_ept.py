...
class WooProductDataQueueEpt(models.Model):
    ...
    def import_product_queue(self):
        self.env['woo.manual.queue.process.ept'].with_context(queue_type='product', active_ids=[self.id]).process_queue_manually()
    ...
    def create(self, vals):
        ...
        res = super(WooProductDataQueueEpt, self).create(vals)
        res.with_delay(description='Sync product from Woo').import_product_queue()
        return res
